...
//------------------------------------------------------------------
bool
detinfo::DetectorClocksStandard::Update(uint64_t ts)
{
  return true;
}
...
//------------------------------------------------------------------
bool
detinfo::DetectorClocksStandard::Configure(fhicl::ParameterSet const& pset)
{
  ...
  fConfigValue.at(kClockSpeedOptical) =
    pset.get<double>(fConfigName.at(kClockSpeedOptical).c_str());
  fConfigValue.at(kClockSpeedTrigger) =
    pset.get<double>(fConfigName.at(kClockSpeedTrigger).c_str());
  fConfigValue.at(kClockSpeedExternal) =
    pset.get<double>(fConfigName.at(kClockSpeedExternal).c_str());
...
//-----------------------------------
{
  ...
  fOpticalClock =
    detinfo::ElecClock(fTriggerTime, fFramePeriod, fConfigValue.at(kClockSpeedOptical));
  fTriggerClock =
    detinfo::ElecClock(fTriggerTime, fFramePeriod, fConfigValue.at(kClockSpeedTrigger));
...
//-----------------------------------------
{
  ...
  std::cout << "Trigger  time @ " << fTriggerTime << std::endl
...
//-----------------------------------------
{
  ...
  SetTriggerTime(cfgValues.at(detinfo::kDefaultTrigTime), cfgValues.at(detinfo::kDefaultBeamTime));
