...
static_assert(!detinfo::timescales::is_tick_v<util::quantities::second>);
static_assert(detinfo::timescales::is_tick_v<util::quantities::tick>);
static_assert(detinfo::timescales::is_tick_v<util::quantities::tick_d>);
static_assert(!detinfo::timescales::is_tick_v<detinfo::timescales::optical_time>);
static_assert(detinfo::timescales::is_tick_v<detinfo::timescales::optical_tick>);
static_assert(detinfo::timescales::is_tick_v<detinfo::timescales::optical_time_ticks>);

//------------------------------------------------------------------------------
static_assert(
  detinfo::timescales::timescale_traits<detinfo::timescales::optical_time>::same_category_as<
    detinfo::timescales::optical_time>);
static_assert(detinfo::timescales::timescale_traits<detinfo::timescales::optical_time>::
...
//------------------------------------------------------------------------------
static_assert(
  detinfo::timescales::optical_time::category_compatible_with<util::quantities::NoCategory>());
static_assert(
  detinfo::timescales::optical_time::category_compatible_with<detinfo::timescales::optical_time>());
static_assert(detinfo::timescales::optical_time::category_compatible_with<
              detinfo::timescales::time_interval>());
static_assert(
  detinfo::timescales::optical_time::category_compatible_with<detinfo::timescales::optical_tick>());
static_assert(detinfo::timescales::optical_time::category_compatible_with<
...
static_assert(
  std::is_same_v<
    detinfo::timescales::optical_tick,
    detinfo::timescales::timescale_traits<detinfo::timescales::OpticalTimeCategory>::tick_t>);
static_assert(std::is_same_v<detinfo::timescales::optical_time_ticks,
...
void test_real_tick_operations()
{
  ...
  static_assert(util::is_same_decay_v<decltype(tick - tick2), tick_interval_d_t>);
