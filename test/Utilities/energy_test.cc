...
void test_electronvolt_literals()
{
  ...
  static_assert(std::is_same<decltype(E_eV), util::quantities::electronvolt const>());
  ...
  static_assert(std::is_same<decltype(E_meV), util::quantities::millielectronvolt const>());
  ...
  static_assert(std::is_same<decltype(E_ueV), util::quantities::microelectronvolt const>());
  ...
  static_assert(std::is_same<decltype(E_keV), util::quantities::kiloelectronvolt const>());
  ...
  static_assert(std::is_same<decltype(E_MeV), util::quantities::megaelectronvolt const>());
  ...
  static_assert(std::is_same<decltype(E_GeV), util::quantities::gigaelectronvolt const>());
  ...
  static_assert(std::is_same<decltype(E_TeV), util::quantities::teraelectronvolt const>());
