...
void test_meter_literals() {
  ...
  static_assert
    (std::is_same<decltype(l_m), util::quantities::meter const>());
  ...
  static_assert
    (std::is_same<decltype(l_km), util::quantities::kilometer const>());
  ...
  static_assert(std::is_same<decltype
    (l_cm), util::quantities::centimeter const>());
  ...
  static_assert
    (std::is_same<decltype(l_mm), util::quantities::millimeter const>());
  ...
  static_assert
    (std::is_same<decltype(l_um), util::quantities::micrometer const>());
  ...
  static_assert
    (std::is_same<decltype(l_nm), util::quantities::nanometer const>());
  ...
  static_assert
    (std::is_same<decltype(l_pm), util::quantities::picometer const>());
  ...
  static_assert
    (std::is_same<decltype(l_fm), util::quantities::femtometer const>());
