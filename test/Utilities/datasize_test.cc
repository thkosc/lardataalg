...
void test_datasize_literals()
{
  ...
  static_assert(std::is_same<decltype(s_kiB), util::quantities::kibibyte const>());
  ...
  static_assert(std::is_same<decltype(s_MiB), util::quantities::mebibyte const>());
  ...
  static_assert(std::is_same<decltype(s_GiB), util::quantities::gibibyte const>());
  ...
  static_assert(std::is_same<decltype(s_TiB), util::quantities::tebibyte const>());
  ...
  static_assert(std::is_same<decltype(s_PiB), util::quantities::pebibyte const>());
  ...
  static_assert(std::is_same<decltype(s_EiB), util::quantities::exbibyte const>());
